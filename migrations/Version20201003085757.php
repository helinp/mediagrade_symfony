 ...
 */
final class Version20201003085757 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        // $this->addSql('ALTER TABLE attendance_grid ADD picture LONGTEXT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE attendance_grid DROP picture');
