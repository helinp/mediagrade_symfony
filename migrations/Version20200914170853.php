 ...
 */
final class Version20200914170853 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE assessment ADD topic_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE assessment ADD CONSTRAINT FK_F7523D701F55203D FOREIGN KEY (topic_id) REFERENCES topic (id)');
        $this->addSql('CREATE INDEX IDX_F7523D701F55203D ON assessment (topic_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_F7523D701F55203D ON assessment');
        $this->addSql('ALTER TABLE assessment DROP topic_id');
    }
}
